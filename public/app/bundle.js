	...
	var UserList = function () {
	  ...
	  _createClass(UserList, [{
	    ...
	    value: function render(container) {
	      ...
	      var source = {
	        datatype: "json",
	        datafields: [{ name: 'username', type: 'string' }, { name: 'name', type: 'string' }, { name: 'email', type: 'string' }],
	        id: "username",
	        url: url
	      };
	      ...
	      var dataGridOptions = {
	        ...
	        columns: [{ text: 'Username', datafield: 'username', width: '30%' }, { text: 'Name', datafield: 'name', width: '40%' }, { text: 'Email', datafield: 'email', width: '30%' }],
	        groups: []
	      };
